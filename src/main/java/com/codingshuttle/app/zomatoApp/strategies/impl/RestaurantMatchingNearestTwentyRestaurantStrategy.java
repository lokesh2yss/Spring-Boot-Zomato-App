...
public class RestaurantMatchingNearestTwentyRestaurantStrategy implements RestaurantMatchingStrategy {
    ...
    public List<Restaurant> findMatchingRestaurants(Customer customer) {
        ...
        return restaurantRepository.findTwentyNearestRestaurants(customerLocation);
    }
}
