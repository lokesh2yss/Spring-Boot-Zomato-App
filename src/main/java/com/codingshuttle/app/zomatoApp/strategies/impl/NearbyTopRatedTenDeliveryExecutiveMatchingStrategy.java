...
public class NearbyTopRatedTenDeliveryExecutiveMatchingStrategy implements DeliveryExecutiveMatchingStrategy {
    ...
    public List<DeliveryExecutive> findMatchingDeliveryExecutives(Order order) {
        ...
        return deliveryExecutiveRepository.findTenNearbyTopRatedDeliveryExecutives(restaurantLocation);
    }
}
